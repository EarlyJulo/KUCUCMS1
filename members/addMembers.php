...
mysqli_query($conn,"insert into members (fname,sname,lname,Gender,Registration,residence,ministry,mobile,email,year,thumbnail,password)
values('$fname','$sname','$lname','$Gender','$Registration','$residence','$ministry,'$mobile','$email','$year','$password','uploads/none.png','$password')")or die(mysqli_error());
