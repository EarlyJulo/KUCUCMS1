   ...
   <script type="text/javascript">
	...
	$('#add').tooltip('hide');
					...
					<div class="control-group">
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="birthday" id="focusedInput" value="<?php echo $row['Registration']; ?>" type="text" placeholder = "Birthday" required>
                                   </p>
                                 </div>
                                  </div>
								  </p>
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="year" id="focusedInput" value="<?php echo $row['year']; ?>" type="text" placeholder = "Year of study" required>
                                   </p>
                                 </div>
                                  </div>
								  </p>
