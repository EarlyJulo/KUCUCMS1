            ...
            <div class="navbar-inner">
               <div class="container-fluid">
				 ...
				 <div class="navbar-header">
                    ...
                    <span class="brand" href="#">KUCU CMS Admin Dashboard</span>
				 </div>
				  <!--.nav-collapse -->
                    <div class="nav-collapse collapse">
						...
						?>
                            <li class="dropdown">
                              <?php
// Check if $row is not null and if the necessary keys exist
if ($row !== null && isset($row['adminthumbnails']) && isset($row['firstname']) && isset($row['lastname'])) {
    ?>
    ...
    // Handle the case where $row is null or some elements are missing
    // You can display a default avatar or name, or output an error message
}
?>
