                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_event.php" method="post">
									...
									<a data-placement="right" title="Click to Delete check item"  data-toggle="modal" href="#user_delete" id="delete"  class="btn btn-danger" name="delete_event"><i class="icon-trash icon-large"> Delete</i></a>
